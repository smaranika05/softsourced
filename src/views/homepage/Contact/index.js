                        ...
                        <div className = "main_form">
                                ...
                                }   
                                {
                                    this.state.cur_contact == 1 ? <>
                                        <div className={`file-upload ${this.state.resume = this.props.t('contact:placeholders.resume') ? 'Lebenslauf' : ''}`}>
                                            <div className="file-select"> 
                                                ...
                                                <input type="file" required name="resume" id="chooseFile" onChange={this.handleChange} placeholder="Lebenslauf"/>
                                            </div>
                                        </div>
                                    </>
                                     : ''
